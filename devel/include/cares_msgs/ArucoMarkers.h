...
struct ArucoMarkers_
{
  ...
  _marker_ids_type marker_ids;
   ...
   typedef std::vector< ::geometry_msgs::Pose_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::geometry_msgs::Pose_<ContainerAllocator> >::other >  _marker_poses_type;
