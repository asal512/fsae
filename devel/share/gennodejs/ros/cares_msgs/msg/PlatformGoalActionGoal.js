...
class PlatformGoalActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new PlatformGoalGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlatformGoalGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += PlatformGoalGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlatformGoalActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = PlatformGoalGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new PlatformGoalGoal()
    }
...
module.exports = PlatformGoalActionGoal;
