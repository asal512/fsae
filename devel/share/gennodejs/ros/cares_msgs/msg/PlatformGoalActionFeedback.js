...
class PlatformGoalActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PlatformGoalFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PlatformGoalFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlatformGoalActionFeedback(null);
    ...
    data.feedback = PlatformGoalFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlatformGoalActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PlatformGoalFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PlatformGoalFeedback()
    }
...
module.exports = PlatformGoalActionFeedback;
