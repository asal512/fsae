...
"""autogenerated by genpy from cares_msgs/PlatformGoalActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class PlatformGoalActionFeedback(genpy.Message):
  _md5sum = "de62d7e0069c1509acac5fc96780ec40"
  _type = "cares_msgs/PlatformGoalActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cares_msgs/PlatformGoalFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlatformGoalActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cares_msgs.msg.PlatformGoalFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cares_msgs.msg.PlatformGoalFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.status,) = _get_struct_B().unpack(str[start:end])
      return self
