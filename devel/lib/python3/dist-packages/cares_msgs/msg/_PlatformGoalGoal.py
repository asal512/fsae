...
"""autogenerated by genpy from cares_msgs/PlatformGoalGoal.msg. Do not edit."""
import codecs
import sys
...
class PlatformGoalGoal(genpy.Message):
  _md5sum = "6ae001c0e475f20505620205aa55b4ab"
  _type = "cares_msgs/PlatformGoalGoal"
...
string data
"""
  __slots__ = ['target_pose','link_id','command','move_mode']
  _slot_types = ['geometry_msgs/PoseStamped','std_msgs/String','uint8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       target_pose,link_id,command,move_mode
    ...
    """
    if args or kwds:
      super(PlatformGoalGoal, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.target_pose is None:
        self.target_pose = geometry_msgs.msg.PoseStamped()
      if self.link_id is None:
        self.link_id = std_msgs.msg.String()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.command, _x.move_mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.link_id.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.link_id.data = str[start:end]
      _x = self
      start = end
      end += 2
      (_x.command, _x.move_mode,) = _get_struct_2B().unpack(str[start:end])
      return self
